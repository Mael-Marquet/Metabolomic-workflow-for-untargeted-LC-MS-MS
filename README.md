...
<img src="assets/workflow_global.png" alt="Global workflow for untargeted LC-MS/MS metabolomics" width="1000"/>
...
-   **Quality control :** Total intensity QC after pre-processing,
    Outlier filtering, Total intensity QC after normalization, PCA on QC
    samples

-   **Correction & Normalization :** Missing value imputation,
    Intra-batch drift correction (LOESS), Data normalization

-   **Transformation :** Data transformation and Scaling

**6. Feature annotation**

-   Feature annotation / putative identification : GNPS2, custom
    databases, Compound Discoverer

**7. Statistical analysis**

-   **Unsupervised** : PCA, HCPC, Heatmap

-   **Supervised** : Random Forest, OPLS-DA, PLS-DA, Volcano plot
...
- `Main_Script.R` — main execution script
- `Modules.R` — workflow functions and modules
- `Initialization.R` — project initialization and directory structure creation
- `assets/` — images and documentation resources
- `renv.lock` — reproducible R package environment
- `.Rprofile` — automatically activates the project environment
- `LICENSE` — MIT license
