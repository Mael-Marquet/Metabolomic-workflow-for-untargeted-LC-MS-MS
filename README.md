...
This workflow requires **R 4.5.2**. To install this exact version (and
switch between versions easily if needed), see the rig
...
**Recommended : use [rig](https://github.com/r-lib/rig)**, a lightweight
R version manager. It installs the exact version required (**R
4.5.2**) and lets you switch between R versions on the same machine
without conflicts — useful since `renv.lock` pins this project to R
4.5.2 specifically.
...
*Alternative :* Download and install R 4.5.2 manually from
...
-   **Windows** : download and install
    ...
    to the system PATH.
-   **macOS** : install the Xcode Command Line Tools, then the
    Fortran compiler [(Xcode and gfortran)](https://mac.r-project.org/tools/) :
