...
check_and_load("dplyr", "1.1.4", FALSE, "Data manipulation grammar")
...
check_and_load("factoextra", "1.0.7", FALSE, "Multivariate visualization")
...
check_and_load("FactoMineR", "2.13", FALSE, "Multivariate analysis")
...
check_and_load("cluster", "2.1.8.1", FALSE, "Clustering algorithms")
...
check_and_load("future", "1.70.0", FALSE, "Future parallel processing")
check_and_load("future.callr", "1.0.0", FALSE, "Callr backend for future")
check_and_load("parallelly", "1.47.0", FALSE, "Parallel backend utilities")
...
check_and_load("igraph", "2.3.3", FALSE, "Graph-based feature grouping")
...
check_and_load("ComplexHeatmap", "2.26.0", TRUE, "Advanced heatmaps")
...
write.table(raw_intensity_matrix_GNPS2, file = paste0(data_folder, "/1_Pre-processing/raw_intensity_matrix_GNPS2.txt"), sep = "\t",
